...
public class TranslatorService {
    ...
    public TranslatorService() {
        ...
        Map<String, String> configMap = JsonUtil.fromJson(json, new TypeReference<Map<String, String>>() {});
        translatorMap = ImmutableMap.<String, Translator>builder()
            .put(Consts.BAIDU_TRANSLATOR, new BaiduTranslator().init(configMap))
            .put(Consts.ALIYUN_TRANSLATOR, new AliyunTranslator().init(configMap))
            .put(Consts.TENCENT_TRANSLATOR, new TencentTranslator().init(configMap))
            .put(Consts.JINSHAN_TRANSLATOR, new JinshanTranslator().init(configMap))
            .put(Consts.YOUDAO_TRANSLATOR, new YoudaoTranslator().init(configMap))
            .build();
    }
