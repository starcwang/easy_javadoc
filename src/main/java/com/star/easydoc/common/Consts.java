...
public final class Consts {
    ...
    public static final Set<String> ENABLE_TRANSLATOR_SET = ImmutableSet.of(Consts.YOUDAO_TRANSLATOR,
        ...
        Consts.GOOGLE_FREE_TRANSLATOR, Consts.CHATGLM_GPT, Consts.OPENAI_GPT, Consts.LOCAL_DICTIONARY,
        Consts.SIMPLE_SPLITTER, Consts.CLOSE_TRANSLATOR, Consts.CUSTOM_URL);
     ...
     * 通用大模型（OpenAI格式）
     */
    public static final String OPENAI_GPT = "通用大模型(OpenAI格式)";
    /**
     * 本地词典
     */
